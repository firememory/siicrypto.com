...
<p>You have requested to deposit <?=$data['data']['amountFiat']?> <?=$data['data']['currency']?> to your SiiCrypto.com account <strong><?=$data['username']?></strong>. From this deposit there will be deducted Bank Charges of minimum <?=$parameters['deposit'][$data['data']['currency']]['min']?> <?=$data['data']['currency']?> and a Fiduciary Fee of <?=$parameters['deposit'][$data['data']['currency']]['percent']?>%.</p>
