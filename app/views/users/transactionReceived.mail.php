...
<div style="border-radius: 10px;-webkit-border-radius: 10px;-moz-border-radius: 10px;">
	...
	<div>
		<table style="width:95%;	align:auto;	margin:auto;	border:0px;	background-color:white;">
			<tr>
				<th style="	padding: 20px 0 20px 0;	background-color:#ddd; font-size:24px">Received Bitcoins BTC
				</th>
			</tr>
			<tr>
				<td><h4>Hi <?=$compact['data']['username']?>,</h4>
						<p class="">We have received Bitcoins (BTC) in your SiiCrypto account</p>
							<table class="">
							<tr class="">
							<th>Date</th>
							<th>Amount BTC</th>
