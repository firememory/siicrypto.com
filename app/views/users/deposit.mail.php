...
<p>You have requested to deposit <?=$compact['data']['data']['data']['amountFiat']?> <?=$compact['data']['data']['Currency']?> to your SiiCrypto.com account <strong><?=$compact['data']['data']['username']?></strong> with Reference No: <strong><?=$compact['data']['data']['Reference']?></strong>. From this deposit there will be deducted Bank Charges of <?=$compact['data']['parameters']['deposit'][$compact['data']['data']['Currency']]['min']?> <?=$compact['data']['data']['Currency']?> and a Fiduciary Fee of <?=$compact['data']['parameters']['deposit'][$compact['data']['data']['Currency']]['percent']?>%.</p>
